...
def find_salary_statistics(df):
    ...
    print(f"\nУровень опыта с максимальной средней зарплатой: '{max_salary_level['Experience_Level']}' ({max_salary_level['Experience_Code']})")
    print(f"Средняя максимальная зарплата: ${max_salary_level['Mean_Salary_USD']:,.2f} USD")
    print(f"Количество специалистов с максимальной средней зарплатой: {int(max_salary_level['Count'])}")
    print(f"Диапазон зарплат: ${max_salary_level['Min_Salary']:,.2f} - ${max_salary_level['Max_Salary']:,.2f} USD")

    print(f"\nУровень опыта с минимальной средней зарплатой: '{min_salary_level['Experience_Level']}' ({min_salary_level['Experience_Code']})")
    print(f"Средняя минимальная зарплата: ${min_salary_level['Mean_Salary_USD']:,.2f} USD")
    print(f"Количество специалистов с минимальной средней зарплатой: {int(min_salary_level['Count'])}")
    print(f"Диапазон зарплат: ${min_salary_level['Min_Salary']:,.2f} - ${min_salary_level['Max_Salary']:,.2f} USD")
...
def additional_analysis(df):
    ...
    print(f"\nОбщая статистика зарплат в USD:")
    print(f"Средняя зарплата: ${df['salary_in_usd'].mean():,.2f}")
    print(f"Медианная зарплата: ${df['salary_in_usd'].median():,.2f}")
    ...
    for level, count in experience_counts.items():
        ...
        print(f"  {level}: {count} записей ({percentage:.1f}%)")
